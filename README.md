...
| --------------- | ---------------------- | -------------------------------------------------------- |
| Администратор   | admin@protuning.ru     | всё: калькулятор, цены, справочники, настройки, бэкап    |
| Менеджер        | manager@protuning.ru   | калькулятор и работа с КП                                |
| Наблюдатель     | viewer@protuning.ru    | просмотр дашборда, списка КП и каждого КП                |
