...
Доступ: два уровня — **Пользователь** (без входа, сразу калькулятор: сборка КП + печать/PDF/копирование)
и **Администратор** (полный доступ через кнопку «Войти»):

| Роль            | E-mail                 | Возможности                                              |
| --------------- | ---------------------- | -------------------------------------------------------- |
| Администратор   | admin@protuning.ru     | всё: калькулятор с сохранением, дашборд, КП, цены, справочники, настройки, бэкап |

Пароль демо-аккаунта: `demo1234`.
